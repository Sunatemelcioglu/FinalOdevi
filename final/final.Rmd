...
library(tidyverse)
library(dplyr)
superbowl_data <- read_excel("C:/Users/begum/OneDrive/Belgeler/superbowl_data.xlsx")
View(superbowl_data)
...
Yapılan Shapiro-Wilk normallik testinde superbowl_data$points_differential değişkeni incelendiğinde p değeri (p=0.01136) 0.05 anlamlılık düzeyinden küçüktür, bu da verilerin dağılımının normal dağılımdan önemli ölçüde farklı olduğunu gösterir. Başka bir deyişle, normal dağılım olduğu varsayılamaz.

shapiro.test(superbowl_data$strength_of_schedule)
superbowl_data$strength_of_schedule) değişkeni incelendiğinde p değeri (p=0.1088) 0.05 anlamlılık düzeyinden büyüktür, bu da verilerin dağılımının normal dağılımdan önemli ölçüde farklı olmadığını gösterir.

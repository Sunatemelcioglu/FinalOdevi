...
## Özet İstatistikler
```{r}
istatistikler <- summary(superbowl_data)
tablo <- data.frame(
  Minimum = istatistikler[, 1],
  Quartile1 = istatistikler[, 2],
  Medyan = istatistikler[, 3],
  Quartile3 = istatistikler[, 4],
  Ortalama = istatistikler[, 6],
  Maksimum = istatistikler[, 7]
)

row.names(tablo) <- NULL
tablo
